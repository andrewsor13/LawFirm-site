...
async function GET() {
    try {
        const contact = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].contact.findUnique({
            where: {
                id: 1
            }
        });
...
async function PATCH(req) {
    ...
    try {
        ...
        const { phone, email, address, mapEmbed } = body;
        const updatedContact = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].contact.update({
            where: {
                id: 1
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2224df9._.js.map