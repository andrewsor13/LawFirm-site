...
async function GET() {
    try {
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].siteSettings.findUnique({
            where: {
                id: "singleton"
            }
        });
...
async function PATCH(req) {
    const { getServerSession } = await __turbopack_context__.r("[project]/node_modules/next-auth/index.js [app-route] (ecmascript, async loader)")(__turbopack_context__.i);
    const { authOptions } = await __turbopack_context__.r("[project]/src/lib/auth.ts [app-route] (ecmascript, async loader)")(__turbopack_context__.i);
    ...
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].siteSettings.update({
            where: {
                id: "singleton"
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ee90352._.js.map