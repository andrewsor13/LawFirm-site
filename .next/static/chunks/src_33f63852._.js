...
function AppProvider({ children }) {
    ...
    const [selectedDomain, setSelectedDomainState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            async function loadHomepageData() {
                try {
                    const [settingsRes, contactRes, domainsRes, postsRes, sessionRes] = await Promise.allSettled([
                        fetch("/api/settings"),
                        fetch("/api/contact"),
                    ...
                    if (settingsRes.status === "fulfilled" && settingsRes.value.ok) setSiteSettings(await settingsRes.value.json());
                    if (contactRes.status === "fulfilled" && contactRes.value.ok) setContact(await contactRes.value.json());
                    if (domainsRes.status === "fulfilled" && domainsRes.value.ok) setDomains(await domainsRes.value.json());
                    if (postsRes.status === "fulfilled" && postsRes.value.ok) setPosts(await postsRes.value.json());
                    if (sessionRes.status === "fulfilled" && sessionRes.value.ok) setSession(await sessionRes.value.json());
                } catch (err) {
    ...
    const setSelectedDomain = async (slugOrDomain)=>{
        try {
...
_s(AppProvider, "DPxKWS8rIxDkNJwqdcPGe9dSLqI=");
_c = AppProvider;
function useAppContext() {
    ...
    if (!ctx) throw new Error("useAppContext trebuie folosit doar în interiorul <AppProvider />");
    return ctx;
}
...
"[project]/src/components/CustomSessionContext.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "CustomSessionContextProvider": (()=>CustomSessionContextProvider),
    "useCustomSession": (()=>useCustomSession)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
...
;
;
const CustomSessionContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function CustomSessionContextProvider({ children }) {
    _s();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CustomSessionContext.Provider, {
        value: {
            session,
            status,
            update
        ...
        fileName: "[project]/src/components/CustomSessionContext.tsx",
        lineNumber: 24,
        columnNumber: 5
    }, this);
}
_s(CustomSessionContextProvider, "PwxIac19F84oZqbKzencSDm+z50=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"]
    ];
});
_c = CustomSessionContextProvider;
const useCustomSession = ()=>{
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(CustomSessionContext);
    if (!context) throw new Error("useCustomSession must be used within CustomSessionContextProvider");
    return context;
};
_s1(useCustomSession, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "CustomSessionContextProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/providers/RootProviders.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SessionProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$CustomSessionContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomSessionContextProvider"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AppContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AppProvider"], {
                ...
                fileName: "[project]/src/providers/RootProviders.tsx",
                lineNumber: 11,
                columnNumber: 9
            }, this)
        }, void 0, false, {
...
//# sourceMappingURL=src_33f63852._.js.map